...
<?= Html::beginTag('h1'); ?>
<?= \Yii::t('skeeks/shop/app', 'New order'); ?> #<?= $model->id; ?> <?= \Yii::t('skeeks/shop/app',
...
<?= Html::endTag('h2'); ?>
<?= Html::beginTag('p'); ?>
    Стоимость товаров: <b><?= Html::tag('b', \Yii::$app->money->intlFormatter()->format($model->moneyOriginal)); ?></b>
    <br/>
    Стоимость доставки: <b><?= Html::tag('b', \Yii::$app->money->intlFormatter()->format($model->moneyDelivery)); ?></b>
    <br/>
